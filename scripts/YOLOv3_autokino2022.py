...
from motrackers import CentroidTracker, CentroidKF_Tracker, KFTracker2D
...
parser.add_argument(
    '--video1', '-v', type=str, default="./../video_input/cars.mp4", help='Input video path.')

parser.add_argument(
    '--video2', '-vv', type=str, default="./../video_input/cars2.mp4", help='Input video path.')
...
"""
Define Area of Intrest for both cameras --> put to transform.py or utils
"""
click_corners_1 = []
click_corners_2 = []
