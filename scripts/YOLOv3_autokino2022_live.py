...
def run_yolo():
    ...
    while True:
        ...
        cv.imshow("Image Camera 1", image_1)

        #correct centroids and transform bounding boxes with perspective transformation matrix
        ...
        #detection on image_2 - bbox has format [xmin,ymin,w,h]
        ...
        cv.imshow("Image Camera 2", image_2)
        ...
        #draw bboxes from camera 2 on white plane and show
